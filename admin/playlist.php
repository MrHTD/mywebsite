...
<div class="mx-4 mt-5">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-auto">
            ...
            <table class="table text-center overflow-scroll table-bordered table-responsive table-hover table-striped">
                <thead>
                    <tr>
                        <th>S. NO</th>
                        <th>TITLE</th>
            ...
            if (mysqli_num_rows($result1) > 0) {
                ...
                if ($page > 1) {
                    echo '<li class="page-item"><a class="page-link border-2 rounded-4 px-4 shadow-lg" href="playlist.php?page=' . ($page - 1) . '">Previous</a></li>';
                }
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    ...
                    echo '<li class="page-item ' . $active . '"><a class="page-link border-2 rounded-4 mx-1 px-4 shadow-lg" href="playlist.php?page=' . $i . '">' . $i . '</a></li>';
                }
            }
            if ($total_page > $page) {
                echo '<li class="page-item"><a class="page-link border-2 rounded-4 px-4" href="playlist.php?page=' . ($page + 1) . '">Next</a></li>';
            }
